...
function DialogFooter({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('desktop:flex-row flex flex-col justify-end gap-2', className)}
      {...props}
    />
  )
}
