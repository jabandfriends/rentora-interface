...
function SelectTrigger({
  ...
  return (
    <Trigger
      ...
      data-size={size}
      className={cn(
        "focus-visible:border-ring focus-visible:ring-theme-primary focus-visible:ring-ring/50 aria-invalid:ring-theme-error/20 dark:aria-invalid:ring-theme-error/40 aria-invalid:border-theme-error shadow-xs bg-theme-light border-theme-secondary-300 flex w-fit items-center justify-between gap-2 whitespace-nowrap rounded-md border px-3 py-2 outline-none transition-[color,box-shadow] focus-visible:ring-[1px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    >
