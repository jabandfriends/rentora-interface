...
import type { CREATE_TENANT_FORM_SCHEMA_TYPE, ICreateTenantRequestPayload } from '@/types'
...
const TenantCreatePage = () => {
  ...
  return (
    <PageSection>
      ...
      />
      <CreateTenantForm onSubmit={onSubmit} isPending={isPending} errorMessage={errorMessage} />
    </PageSection>
  )
}
